function [extracted_watermark] = extract_old(source_file_path, ...
                                             result_file_path, ...
                                             sub_matrix_size, ...
                                             wavelet_name)
...
function extracted_bits = extract_bits_from_frame(frame, ...
    ...
    extracted_bits = extract_bits(S_W_prime, sub_matrix_size);
end

function bits = extract_bits(s_matrix, sub_matrix_size)
