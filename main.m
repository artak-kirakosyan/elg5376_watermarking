...
watermarks_source_path = "watermarks";
watermarks_struct = dir(fullfile(watermarks_source_path, '*.png'));

for t=1:length(watermarks_struct)
    watermark_path = watermarks_struct(t).name;
    watermark_path = string(watermark_path);
    watermark_name = watermark_path.replace(".png", "");
    watermark_path = watermarks_source_path + '/' + watermark_path;
    results_dir = 'results/'+ watermark_name + '/';
    ...
    attacks = ["no_attack", "gauss 10", "gauss 15", ...
               "filter 4000", "quantize", ...
               "downsample 11025", ];
